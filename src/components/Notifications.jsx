              ...
              {loading ? (
                ...
                notifs.map((n) => (
                  <div 
                    ...
                    className={`group p-4 rounded-2xl border flex items-center gap-4 transition-all cursor-pointer ${
                      n.is_read ? 'bg-slate-900/40 border-slate-900 opacity-60' : 'bg-slate-900 border-slate-800 shadow-lg shadow-blue-500/5'
                    }`}
                  >
                    ...
                    {n.data?.poster_path && (
                      <img src={n.data.poster_path} alt="" className="w-10 h-14 object-cover rounded-lg border border-slate-800" />
                    )}
                  </div>
                ))
              )}
